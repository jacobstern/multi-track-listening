...
config :multi_track_listening, MultiTrackListeningWeb.HomeController,
  featured_mix_ids: [2, 8, 4, 1]
...
# start per endpoint:
#
#     config :multi_track_listening, MultiTrackListeningWeb.Endpoint, server: true
#
